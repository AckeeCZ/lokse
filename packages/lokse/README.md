...
lokse/1.5.1 darwin-x64 node-v12.21.0
$ lokse --help [COMMAND]
USAGE
  $ lokse COMMAND
...
...
_See code: [src/commands/open.ts](https://github.com/AckeeCZ/lokse/blob/v1.5.1/src/commands/open.ts)_
...
_See code: [src/commands/update.ts](https://github.com/AckeeCZ/lokse/blob/v1.5.1/src/commands/update.ts)_
<!-- commandsstop -->
