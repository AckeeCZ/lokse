...
import type { GeneralPluginOptions, LoksePlugin, TransformFullOutputMeta } from '@lokse/core';
...
export default function (options: GeneralPluginOptions): LoksePlugin {
    ...
    return createPlugin({
        transformFullOutput: async (output: string, meta: TransformFullOutputMeta) => {
